...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Gru 2017, 15:19
...
CREATE TABLE `transfer` (
  ...
  `typ` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `transfer` (`id`, `id_pilkarz`, `id_klub`, `id_nowy_klub`, `typ`, `kwota`) VALUES
(2, 3, 4, 5, 'Transfer', '25000.00'),
(3, 4, 5, 4, 'Wypożyczenie', '4000.00'),
(4, 5, NULL, 6, 'Koniec Umowy', '200.00'),
(5, 4, 5, 4, 'Wypożyczenie', '200000.00'),
(7, 4, 5, 7, 'Wypożyczenie', '200.00');
...
CREATE TABLE `ulubione` (
  ...
  `pilkarz` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `klub` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  `liga` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
